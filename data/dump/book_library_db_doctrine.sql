...
DROP INDEX public.country_code_id_unq;
DROP INDEX public.country_code3_id_unq;
DROP INDEX public.country_code2_id_unq;
...
--
-- Name: country_code2_id_unq; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX country_code2_id_unq ON public.country USING btree (code2);


--
-- Name: country_code3_id_unq; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX country_code3_id_unq ON public.country USING btree (code3);


--
-- Name: country_code_id_unq; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX country_code_id_unq ON public.country USING btree (code);
...
ALTER TABLE ONLY public.text_document_to_author
    ADD CONSTRAINT fk_262e170d379f864 FOREIGN KEY (text_document_id) REFERENCES public.text_documents(id);
